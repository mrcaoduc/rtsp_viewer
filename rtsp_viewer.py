...
class RTSPViewer(QMainWindow):
    def __init__(self):
        ...
        self.vlc_instance = vlc.Instance('--no-xlib --verbose=2 --network-caching=10000 --no-video-title-show '
                                         '--clock-jitter=0 --clock-synchro=0 --rtsp-frame-buffer-size=1000000')
    ...
    def update_streams(self, urls_text):
        ...
        for i, url in enumerate(new_urls):
            ...
            media.add_option('rtsp-tcp')  # Try TCP
            media.add_option('rtsp-udp')  # Fallback to UDP
